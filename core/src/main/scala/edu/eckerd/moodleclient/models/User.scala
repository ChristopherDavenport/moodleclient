...
@JsonCodec case class User(
                            ...
                            firstaccess : Option[BigDecimal] = None, //first access to the site (0 if never)
                            lastaccess : Option[BigDecimal] = None, //last access to the site (0 if never)
                            auth : Option[String] = None, //Auth plugins include manual, ldap, imap, etc
                            ...
                            timezone : Option[String] = None, //Timezone code such as Australia/Perth, or 99 for default
